...
import { View, ScrollView, TouchableOpacity, ActivityIndicator, Switch, Alert } from "react-native";
...
export default function ProfileScreen() {
  ...
  return (
    <View style={styles.screen}>
      ...
      <ConfirmDialog visible={deleteModalVisible} onClose={() => setDeleteModalVisible(false)}>
